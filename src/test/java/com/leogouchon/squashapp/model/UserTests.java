...
public class UserTests {
    ...
    public void testConstructor() {
        User user = new User("john.doe@mail.com", "p@s5w0rD");
        assertNotNull(user);
    ...
    public void testConstructorWithNullPassword() {
        Exception exception = assertThrows(NullPointerException.class, () -> {
            new User("john.doe@mail.com", null);
        });
    ...
    public void testConstructorWithPlayer() {
        ...
        User user = new User("john.doe@mail.com", "p@s5w0rD", player);
