...
ALTER TABLE kicker_matches DROP CONSTRAINT kicker_matches.kicker_matches_pkey;
...
ALTER TABLE refresh_token DROP CONSTRAINT refresh_token.fk_refresh_token_users;
...
ALTER TABLE users DROP CONSTRAINT users.users_pkey;
...
ALTER TABLE refresh_token DROP CONSTRAINT refresh_token.refresh_token_pkey;
...
ALTER TABLE invitation_token DROP CONSTRAINT invitation_token.invitation_token_pkey;
...
ALTER TABLE squash_matches DROP CONSTRAINT squash_matches.matches_pkey;
...
UPDATE users u SET player_id_tmp = p.id_tmp FROM players p WHERE u.players_id = u.id;
UPDATE squash_matches s SET player_a_id_tmp = p.id_tmp FROM players p WHERE s.player_a_id = p.id;
UPDATE squash_matches s SET player_b_id_tmp = p.id_tmp FROM players p WHERE s.player_b_id = p.id;
UPDATE kicker_matches k SET player_one_team_a_id_tmp = p.id_tmp FROM players p WHERE k.player_one_team_a_id = p.id;
UPDATE kicker_matches k SET player_two_team_a_id_tmp = p.id_tmp FROM players p WHERE k.player_two_team_a_id = p.id;
UPDATE kicker_matches k SET player_one_team_b_id_tmp = p.id_tmp FROM players p WHERE k.player_one_team_b_id = p.id;
UPDATE kicker_matches k SET player_two_team_b_id_tmp = p.id_tmp FROM players p WHERE k.player_two_team_b_id = p.id;
UPDATE invitation_token i SET player_id_tmp = p.id_tmp FROM players p WHERE i.player_id = p.id;

ALTER TABLE users DROP CONSTRAINT users.fk_users_players;
ALTER TABLE squash_matches DROP CONSTRAINT squash_matches.fk_matches_player_a;
ALTER TABLE squash_matches DROP CONSTRAINT squash_matches.fk_matches_player_b;
ALTER TABLE kicker_matches DROP CONSTRAINT kicker_matches.fk_kicker_matches_player_one_team_a;
ALTER TABLE kicker_matches DROP CONSTRAINT kicker_matches.fk_kicker_matches_player_two_team_a;
ALTER TABLE kicker_matches DROP CONSTRAINT kicker_matches.fk_kicker_matches_player_one_team_b;
ALTER TABLE kicker_matches DROP CONSTRAINT kicker_matches.fk_kicker_matches_player_two_team_b;
ALTER TABLE invitation_token DROP CONSTRAINT invitation_token.fk_invitation_token_players;

ALTER TABLE players DROP CONSTRAINT users.users_pkey;
