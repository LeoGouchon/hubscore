...
public class Matches {
    ...
    public Matches(Players playerA, Players playerB, String pointsHistory) {
     ...
     */
    private Integer getPlayerScore(Players player) {
        PlayerLetter playerLetter = Matches.PlayerLetter.valueOf(player.equals(playerA) ? "A" : "B");
        Integer finalScore = playerLetter == Matches.PlayerLetter.A ? getFinalScoreA() : getFinalScoreB();
        if (finalScore != null) {
            return finalScore;
        }
     ...
     */
    private Boolean isServiceSideCorrect(Players player, ServiceSide serviceSide) {
     ...
     */
    public void addService(Players player, String serviceSide) {
